...
public class shambaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(itenId == R.id.Home){
                    Intent intent = new Intent(shambaActivity.this, home_page_activity_main.class);
                    startActivity(intent);
                    drawerLayout.close();
                } else if (itenId == R.id.Chart) {
                    Intent intent = new Intent(shambaActivity.this, edite_activity.class);
                    startActivity(intent);
                    drawerLayout.close();
                }else if (itenId == R.id.Uza) {
                    Intent intent = new Intent(shambaActivity.this,uzaMainActivity.class);
                    startActivity(intent);
                    intent.putExtra("username", username); // Pass the username to the UploadActivity
                    startActivity(intent);
                    drawerLayout.close();
                }else if (itenId == R.id.Nunua) {
                    Intent intent = new Intent(shambaActivity.this,nunuaMainActivity.class);
                    startActivity(intent);
                    intent.putExtra("username", username); // Pass the username to the UploadActivity
                    startActivity(intent);
                    drawerLayout.close();
                }else if (itenId == R.id.Help) {
                    Intent intent = new Intent(shambaActivity.this,MainActivityfaq.class);
                    startActivity(intent);
                    intent.putExtra("username", username); // Pass the username to the UploadActivity
                    startActivity(intent);
                    drawerLayout.close();
                }else if (itenId == R.id.Feedback) {
                    Toast.makeText(shambaActivity.this,text7, Toast.LENGTH_SHORT).show();
                }else if (itenId == R.id.FAQ) {
                    Toast.makeText(shambaActivity.this, text8, Toast.LENGTH_SHORT).show();
                }
        ...
        uploadFileBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kitu.isEmpty() || number.isEmpty() || mkoawake.isEmpty()){
                    Toast.makeText(shambaActivity.this, "Tafadhali jaza taarifa zote kuendelea", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    if (fileUri != null) {
                        ...
                        Toast.makeText(shambaActivity.this, "Please select a file first", Toast.LENGTH_SHORT).show();
                    }
            ...
            fileRef.putFile(fileUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(shambaActivity.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(shambaActivity.this, "File upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void saveFileUrlToDatabase(String downloadUrl) {
        ...
        if (!kitu.isEmpty() || !mkoa.isEmpty() || !phone.isEmpty()) {
            ...
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("shamba");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(shambaActivity.this, "Data sent successfully", Toast.LENGTH_SHORT).show();
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(shambaActivity.this, "Failed to save data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
            // Using a Map to store the username directly

        } else {
            Toast.makeText(shambaActivity.this, "Fill all spaces", Toast.LENGTH_SHORT).show();
        }
    ...
    public void data() {
        ...
        if (!kitu.isEmpty() || !mkoa.isEmpty() || !phone.isEmpty()) {
            ...
            FirebaseDatabase.getInstance().getReference("shamba").child(kitu)
